...
var Form = (function(){
    ...
    _private.ajaxSettings = {
        beforeSubmit: function (arr, $form, options) {
            if(_private.callback.on == 'beforeSubmit' && _private.callback.default !== false) {
        ...
        success: function (result, status, xhr, $form) {
            if(_private.callback.on == 'success' && _private.callback.default !== false) {
                $form.find('.form-status')
        ...
        error: function (result, status, xhr, $form) {
            if(_private.callback.on == 'error' && _private.callback.default !== false) {
                $form.find('.form-status')
                     .removeClass('form-sending')
                     .addClass('form-error');
